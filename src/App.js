                    ...
                    <a className="navbar-brand m-0"
                       ...
                       target="_blank">
                        <img src="/assets/img/logo-ct.png" className="navbar-brand-img h-100"
                             alt="main_logo"/>
                        <span className="ms-1 font-weight-bold text-white">A.H.K Perera</span>
                    </a>
                </div>
            ...
            <div className="fixed-plugin">
                ...
                <div className="card shadow-lg">
                    ...
                    <span className="badge filter bg-gradient-primary active" data-color="primary"
                        ...
                        <p className="text-sm d-xl-none d-block mt-2">You can change the sidenav type just on desktop
                            view.</p>
